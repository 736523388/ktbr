...
class BannerController extends AdminBaseController{
	...
	public function index(){
		...
		$list = $Banner->order('sort')->limit($Page->firstRow.','.$Page->listRows)->select();
		$assign=[
            'list'=>$list,
            'page'=>$show,
		];
	...
	public function add(){
		...
		$result=D('AdminBanner')->addData($data);
		if ($result) {
	...
	public function edit(){
		...
		$result=D('AdminBanner')->editData($map,$data);
		if ($result) {
	...
	public function delete(){
		...
		$result=D('AdminBanner')->deleteData($map);
		if($result){
	...
	public function order(){
		$data=I('post.');
		$result=D('AdminBanner')->orderData($data,'id','sort');
		if ($result) {
