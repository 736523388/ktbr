...
function case_category_name($id){
    if(empty($id)){
        return '';
    }
...
function post_category_name($id){
    if(empty($id)){
        return '';
    }
    if(!$info=M('PostCategory')->find($id)){
        return '';
    }
    return $info['title'];
}
...
function video_brand_industry($id){
    if(empty($id)){
        return '';
    }
    if(!$info=M('Video')->field('brand,industry')->find($id)){
        return '';
    }
    // return $info['brand'];
    $brand=M('VideoBrand')->field('title')->find($info['brand']);
    $industry=M('VideoIndustry')->field('title')->find($info['industry']);
    if(!$brand||!$industry){
        return '';
    }
    return $brand['title'].'/'.$industry['title'];
}
function curPageURL() 
{
  $pageURL = 'http';
