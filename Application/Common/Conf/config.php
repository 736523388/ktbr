...
//*************************************附加设置***********************************
    ...
    'TMPL_PARSE_STRING'      => array(                           // 定义常用路径
        ...
        '__HOME_PICTURE__'    => OSS_URL.trim(TMPL_PATH,'.').'Home/Public/picture',
...
//*************************************路由设置*************************************
    ...
    'URL_ROUTE_RULES'        =>array(
        // 'anli'   =>'Home/Anli/index',
        'about'  =>'Home/Index/about',
        '/^anli\/(\d+)-(\d+)-(\d+)$/'  => 'Home/Anli/index?oid=:1&mid=:2&p=:3',
        'anli'                   =>'Home/Anli/index?oid=0&mid=0&p=1',
        'anli_details/:id\d'     =>'Home/Anli/details',
        '/^category\/(\d+)-(\d+)-(\d+)-(\d+)-(\d+)$/'  => 'Home/Video/index?bid=:1&iid=:2&yid=:3&tid=:4&p=:5',
        'category'                   =>'Home/Video/index?bid=0&iid=0&yid=0&tid=0&p=1',
        'video/:id\d'     =>'Home/Video/details',
        'admins'          =>'Home/Index/login',
        'post/[:id\d]'    =>'Home/Post/index',
        'post_details/:id\d' =>'Home/Post/details',
    ),
//***********************************URL设置**************************************
...
//***********************************缓存设置**********************************
    ...
    'FFMPEG_PATH'=>'L:/ffmpeg/bin/ffmpeg -i "%s" 2>&1',//ffmpeg安装路径
);
